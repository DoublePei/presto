...
import io.prestosql.operator.aggregation.VarcharSumAggregation;
...
import io.prestosql.operator.aggregation.arrayagg.CollectAggregationFunction;
...
public class FunctionRegistry
{
    ...
    public FunctionRegistry(TypeManager typeManager, BlockEncodingSerde blockEncodingSerde, FeaturesConfig featuresConfig)
    {
        ...
        FunctionListBuilder builder = new FunctionListBuilder()
                ...
                .aggregates(VarcharSumAggregation.class)
